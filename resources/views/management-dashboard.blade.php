            ...
            <div class="col-span-1">
                <div class="grid grid-cols-2 gap-2">
                    <div class="rounded-xl hover:border hover:border-stroke hover:bg-white py-12 px-7.5 hover:shadow-xl text-center">
                        <h1 class="text-lg">WIP</h1>
                        <h1 class="text-4xl font-bold mt-3 mb-10">0</h1>
                    </div>
                    <div class="rounded-xl hover:border hover:border-stroke hover:bg-white py-12 px-7.5 hover:shadow-xl text-center">
                        <h1 class="text-lg">Profitable Customers (%)</h1>
                        <h1 class="text-4xl font-bold mt-3 mb-10">100</h1>
                    </div>
                </div>
                <div class="mt-3">
                    <x-management-chart-three />
                </div>
            </div>
            <div class="col-span-1">
                <div class="">
                    <x-management-chart-one />
                </div>
                <div class="mt-3">
                    <x-management-table-one />
                </div>
            </div>
            <div class="col-span-1">
                <div class="">
                    <x-management-chart-two />
                </div>
                <div class="mt-3">
                    <x-management-table-two />
                </div>
            </div>
        </div>
    </div>
