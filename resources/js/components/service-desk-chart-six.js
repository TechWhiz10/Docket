...
const serviceDeskChartSix = () => {
    ...
    const chartSelector = document.querySelectorAll("#service-desk-chart-six");

    if (chartSelector.length) {
        const chart = new ApexCharts(
            document.querySelector("#service-desk-chart-six"),
            chartOptions
        );
        chart.render();
    }
...
export default serviceDeskChartSix;
